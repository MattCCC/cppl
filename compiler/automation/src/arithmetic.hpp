...
[[nodiscard]] std::optional<kernel::ArithmeticCertificate> refute(
    const kernel::ArithmeticSystem& system);
...
[[nodiscard]] std::optional<kernel::ProofTerm> arithmetic_evidence(
