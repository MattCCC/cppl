...
int main() {
    if (updated(4u) != 9u || scaled(2ul) != 11ul || updated(4294967295u) != 4294967295u)
        return 16;
    if (chained(1u) != 3u || latest(1u) != 7u || declared_together(2u) != 2u)
        return 1;
    if (preserved(1u) != 1u)
        return 11;
    if (deduced(3u) != 3u || braced(4u) != 4u)
        return 2;
    if (choose_then_adjust(5u, true) != 5u || choose_then_adjust(5u, false) != 5u)
        return 3;
    if (merged(true) != 2u || merged(false) != 1u)
        return 4;
    if (both_arms(true, 3u) != 10u || both_arms(false, 3u) != 0u)
        return 5;
    if (nested_assignments(true, true, 9u) != 1u || nested_assignments(true, false, 9u) != 2u ||
        nested_assignments(false, true, 9u) != 3u)
        return 6;
    if (shadowed(6u) != 6u)
        return 7;
    if (call_in_initializer(7u) != 7u || call_in_assignment(8u) != 8u)
        return 8;
    if (guarded_call(9u) != 9u || guarded_call(90u) != 10u)
        return 9;
    if (local_guard(2u) != 2u || local_guard(20u) != 10u)
        return 10;
    if (flag_guard(3u) != 3u || flag_guard(30u) != 10u)
        return 12;
    if (clamped_guard(4u) != 4u || clamped_guard(40u) != 10u)
        return 13;
    if (constant_arm(true) != 1u || constant_arm(false) != 1u)
        return 14;
    if (declared_in_arm(5u, true) != 5u || declared_in_arm(5u, false) != 5u)
        return 15;
    return 0;
}
